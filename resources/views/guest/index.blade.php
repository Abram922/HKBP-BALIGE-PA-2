  ...
  <body>
        <div class="slideshow" style="width: 100%; margin: 0;">
            <div class="home-slider owl-carousel js-fullheight">
                ...
                <div class="slider-item js-fullheight" style="background-image:url(images/alberttt.jpeg);">
                    <div class="overlay"></div>
                    <div class="container">
                        <div class="row no-gutters slider-text js-fullheight align-items-center ">
                            <div class="col-md-12 ftco-animate">
                ...
                <div class="slider-item js-fullheight" style="background-image:url(images/albertt.jpeg);">
                    <div class="overlay"></div>
                    <div class="container">
                        <div class="row no-gutters slider-text js-fullheight align-items-center ">
                            <div class="col-md-12 ftco-animate">
    ...
    <script src="{{ asset('js/main.js') }}"></script> --}}
        ...
        <div class="container">
            ...
            <table border="0" style="font-size:20px; text-align:center;">
                ...
                <td><a href="/file/{{ $product->image }}" target="_blank" class="btn btn-warning" download>Lihat File</a></td>  <!--tambahh download untuk mengunduh file -->
