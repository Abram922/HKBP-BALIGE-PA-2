    ...
    <div class="container">
        ...
        <div class="card mt-5 d-flex justify-content-center">
            <div class="card-header text-center">
                <strong>UPDATE PARHALADO</strong>
            </div>
            ...
            {{-- card body --}}
            <div class="card-body">
                <form action="{{ route('parhalados.update', $parhalado->id) }}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name"
                            autofocus value="{{ old('name', $parhalado->name) }}">
                        @error('title')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('title') is-invalid @enderror" name="title"
                            id="title" autofocus value="{{ old('title', $parhalado->title) }}">
                        @error('title')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="lunggu" rows="10" name="lunggu"
                            value="{{ old('lunggu', $parhalado->lunggu) }}">
                        @error('lunggu')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
