...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="panel panel-default">
        ...
        <a href="{{ route('parhalados.create') }}">
            <button type="button" class="btn btn-sm btn-success"><i class="fas fa-plus"></i>Tambah</button>
        </a>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('parhalados.destroy', $parhalado->id) }}" method="POST">
                            @method('delete')
                            @csrf
                            <button type="submit" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus data?')">Hapus</i></button>
                        </form>

                        {{-- button delete --}}
                        {{-- <button class="btn btn-danger" data-toggle="modal"
                                    data-target="#exampleModal{{ $parhalado->id }}"><i class="bi bi-trash3-fill"></i></button> --}}
                        <!-- Modal delete-->
