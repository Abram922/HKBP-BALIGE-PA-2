                ...
                <tbody>
                    @foreach ($ting as $product)
                        <tr>
                            ...
                            <td><a href="/file/{{ $product->image }}" target="_blank" class="btn btn-warning"
                                    download>Lihat File</a></td>
                    ...
                    <div class="row">
                        @foreach ($renungan as $renungans)
                            <div class="col-md-12 pl-lg-2 mb-5">
                                ...
                                <p class="card-title">Diposting oleh: {{ $renungans->user->name }},
                                    {{ $renungans->created_at->diffForHumans() }}</p>
                                <div class="mb-2">
                                    <img src="/image/{{ $renungans->image }}" class="card-img" alt="..."
                                ...
                                {{-- <a href="/usershowrenungan/{{ $renungans->id }}">
