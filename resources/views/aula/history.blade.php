            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @elseif ($booking->status_id == 2 && $booking->metode_pembayaran == 1)
                        <p>{{$booking->status_bayar->status_pembayaran}}</p>

                        @elseif ($booking->status_id == 2 && $booking->metode_pembayaran == 2)
                        <p>{{$booking->status_bayar->status_pembayaran}}</p>
